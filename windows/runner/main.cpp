                      ...
                      _In_ wchar_t *command_line, _In_ int show_command)
{
  ...
  if (SendAppLinkToInstance(L"Sod"))
  {
    return EXIT_SUCCESS;
  }

  HANDLE hMutexInstance = CreateMutex(NULL, TRUE, L"SodMutex");
  HWND handle = FindWindowA(NULL, "Sod");
  ...
  if (GetLastError() == ERROR_ALREADY_EXISTS)
  {
    ...
    if (window.SendAppLinkToInstance(L"Sod"))
    {
      return false;
    }
  ...
  if (!window.Create(L"Sod", origin, size))
  {
    return EXIT_FAILURE;
  }
